...
// Extend generic material to include our custom shader
...
function ShaderPlane() {
  ...
  useFrame((state) => {
    ...
    // Responsive scaling to ensure coverage
  ...
  return (
    <mesh ref={meshRef} position={[0, 0, 0]}>
      {/* 
        Plane geometry 1x1. We scale it up to viewport size in useFrame. 
        This ensures it always covers the screen exactly (or more) 
      */}
...
export function ShaderBackground() {
  ...
  useGSAP(
    ...
    { scope: canvasRef } // Scope to the specific ref
  );
  ...
  return (
    ...
    >
      ...
      {/* Extra overlay for better text contrast if needed */}
